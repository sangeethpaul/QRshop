  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <a 
        href={src} 
        download="qrcode.png" 
        className="mt-4 text-xs font-bold text-primary hover:text-indigo-700 transition-all flex items-center gap-2 px-4 py-2 bg-slate-100 rounded-lg hover:bg-slate-200"
      >
